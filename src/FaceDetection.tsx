            ...
            {image && (
                <View style={styles.imageContainer}>
                    ...
                    <View style={styles.colorPicker}>
                        ...
                        <TouchableOpacity onPress={() => setLipColor('red')} style={[styles.colorButton, { backgroundColor: 'red' }]} />
                        <TouchableOpacity onPress={() => setLipColor('black')} style={[styles.colorButton, { backgroundColor: 'black' }]} />
                        <TouchableOpacity onPress={() => setLipColor('green')} style={[styles.colorButton, { backgroundColor: 'green' }]} />
                    </View>
                </View>
            )}
        </View>
